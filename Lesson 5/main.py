...
class PlaylistWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.inp_search.setPlaceholderText("Поиск по названию или исполнителю...")
        ...
        btn_delete = QPushButton("🗑 Удалить выбранный трек")
        ...
        btn_add.setStyleSheet(
            ...
            "font-weight:bold; padding:6px 14px; border-radius:6px;"
        )
    ...
    def on_search(self, text: str):
        ...
        if text:
            self.load_table(self.db.search(text))
        else:
            self.load_table()
